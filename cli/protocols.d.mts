...
// Signed spend statements. Its own version line, and part of CLIENT_PROTOCOLS
// since the format was published — see the note in protocols.mjs.
export const STATEMENT_PROTOCOL: ProtocolRange;
