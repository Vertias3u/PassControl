...
export default function CookiesPage() {
  return (
    <LegalPage title="Cookies and local storage." summary="PassControl uses storage needed for sign-in, account recovery and an operator-selected time-zone preference. It has no advertising cookies.">
